...
//     @MockBean
//     private com.sap.springhanacloudfoundry.services.EmployeeService employeeService;
...
//                 .id(1)
//                 .build();
//         given(employeeService.insertEmployee(any(Employee.class)))
...
//         given(employeeService.findAllEmployee()).willReturn(listOfEmployees);
...
//                 .email("ram@gmail.com")
//                 .build();
//         given(employeeService.findEmployeeById(employeeId)).willReturn(updatedEmployee);
//         // given(employeeService.updateEmployee(any(Employee.class)))
//         //         .willAnswer((invocation)-> invocation.getArgument(0));
